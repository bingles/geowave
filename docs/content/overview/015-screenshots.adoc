...
image::t-drive-points-3.jpg[scaledwidth="100%",alt="T-drive points at building scale"]
_Graphic background(C)MapBox and (C)OpenStreetMap_

image::t-drive-density-3.jpg[scaledwidth="100%",alt="T-drive density at building scale"]
_Graphic background(C)MapBox and (C)OpenStreetMap_
